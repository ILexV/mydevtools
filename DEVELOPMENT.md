...
### Шаг 5: Оптимизация HEAD запросов (SEO)

Добавьте slug нового инструмента в массив `ToolSlugs` в файле `Middleware/HeadRequestMiddleware.cs`. Это позволит поисковым ботам получать быстрый ответ `200 OK` при проверке доступности страницы.
