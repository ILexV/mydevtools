...
✅ **ОБЯЗАТЕЛЬНО:**
- **Тестировать UI в реальном браузере** (визуальная проверка обязательна при любых изменениях интерфейса)
...
### 2026-01-26
- Добавлено требование обязательного тестирования UI в браузере при изменениях интерфейса
